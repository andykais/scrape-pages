...
const Input = lib_1.default.type("Input", lib_1.default.ref(InputKey));
...
exports.ScrapeConfigInit = lib_1.default.type("ScrapeConfigInit", lib_1.default.object(lib_1.default.property("download", lib_1.default.ref(exports.DownloadConfigInit), true), lib_1.default.property("parse", lib_1.default.ref(exports.ParseConfigInit), true), lib_1.default.property("incrementUntil", lib_1.default.ref(Incrementers), true), lib_1.default.property("limitValuesTo", lib_1.default.number(), true)));
exports.ScrapeConfig = lib_1.default.type("ScrapeConfig", lib_1.default.object(lib_1.default.property("download", lib_1.default.ref(exports.DownloadConfig), true), lib_1.default.property("parse", lib_1.default.ref(exports.ParseConfig), true), lib_1.default.property("incrementUntil", lib_1.default.ref(Incrementers)), lib_1.default.property("limitValuesTo", lib_1.default.union(lib_1.default.number(), lib_1.default.undef()))));
const StructureInit = lib_1.default.type("StructureInit", StructureInit => lib_1.default.object(lib_1.default.property("scraper", lib_1.default.ref(exports.ScraperName)), lib_1.default.property("forEach", lib_1.default.union(lib_1.default.ref(StructureInit), lib_1.default.array(lib_1.default.ref(StructureInit))), true), lib_1.default.property("forNext", lib_1.default.union(lib_1.default.ref(StructureInit), lib_1.default.array(lib_1.default.ref(StructureInit))), true)));
const Structure = lib_1.default.type("Structure", Structure => lib_1.default.intersect(lib_1.default.ref(StructureInit), lib_1.default.object(lib_1.default.property("forEach", lib_1.default.array(lib_1.default.ref(Structure))), lib_1.default.property("forNext", lib_1.default.array(lib_1.default.ref(Structure))))));
exports.ConfigInit = lib_1.default.type("ConfigInit", lib_1.default.object(lib_1.default.property("input", lib_1.default.union(lib_1.default.ref(Input), lib_1.default.array(lib_1.default.ref(Input))), true), lib_1.default.property("import", lib_1.default.union(lib_1.default.ref(Import), lib_1.default.array(lib_1.default.ref(Import))), true), lib_1.default.property("scrapers", lib_1.default.object(lib_1.default.indexer("scraperName", lib_1.default.string(), lib_1.default.ref(exports.ScrapeConfigInit)))), lib_1.default.property("run", lib_1.default.ref(StructureInit))));
// returned by ./normalize.ts
exports.Config = lib_1.default.type("Config", lib_1.default.intersect(lib_1.default.ref(exports.ConfigInit), lib_1.default.object(lib_1.default.property("input", lib_1.default.array(lib_1.default.ref(Input))), lib_1.default.property("import", lib_1.default.array(lib_1.default.ref(Import))), lib_1.default.property("scrapers", lib_1.default.object(lib_1.default.indexer("scraperName", lib_1.default.string(), lib_1.default.ref(exports.ScrapeConfig)))), lib_1.default.property("run", lib_1.default.ref(Structure)))));
