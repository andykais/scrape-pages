...
FMap = FMap_1 = __decorate([
    lib_1.default.annotate(lib_1.default.class("FMap", FMap => {
        ...
        return [lib_1.default.extends(lib_1.default.ref("Map.2685527372", K, V)), lib_1.default.property("getOrElse", lib_1.default.any()), lib_1.default.property("getOrThrow", lib_1.default.any()), lib_1.default.property("map", lib_1.default.any())];
    }))
], FMap);
exports.FMap = FMap;
